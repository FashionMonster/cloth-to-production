      ...
      <div className="grid grid-cols-3 gap-1">
        <div className="grid grid-cols-2 gap-1">
          <SelectComposition
            name="composition1"
            id="composition1"
            register={props.register("composition1")}
          ...
          <InputCompositionRatio
            ...
            register={props.register("compositionRatio1")}
            getValues={props.getValues}
            setError={props.setError}
            clearErrors={props.clearErrors}
        ...
        <div className="grid grid-cols-2 gap-1">
          <SelectComposition
            name="composition2"
            id="composition2"
            register={props.register("composition2")}
            getValues={props.getValues}
            setError={props.setError}
            clearErrors={props.clearErrors}
          ...
          <InputCompositionRatio
            ...
            register={props.register("compositionRatio2")}
            getValues={props.getValues}
            setError={props.setError}
            clearErrors={props.clearErrors}
        ...
        <div className="grid grid-cols-2 gap-1">
          <SelectComposition
            name="composition3"
            id="composition3"
            register={props.register("composition3")}
            getValues={props.getValues}
            setError={props.setError}
            clearErrors={props.clearErrors}
          ...
          <InputCompositionRatio
            ...
            register={props.register("compositionRatio3")}
            getValues={props.getValues}
            setError={props.setError}
            clearErrors={props.clearErrors}
